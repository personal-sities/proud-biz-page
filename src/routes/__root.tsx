...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ACCURATE VALUE — Professional Valuation Services" },
      { name: "description", content: "ACCURATE VALUE MCHJ provides certified valuation services for motor vehicles, real estate, and businesses in Uzbekistan." },
      { name: "author", content: "ACCURATE VALUE" },
      { property: "og:title", content: "ACCURATE VALUE — Professional Valuation Services" },
